...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="col-md-9 col-md-offset-2" id="new-product-type-alert-place">
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-7 hidden" id="product-type-editor">

            <div class="row" id="product-type-values">
